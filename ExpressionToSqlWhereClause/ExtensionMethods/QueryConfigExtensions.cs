...
public static class QueryConfigExtensions
{
    ...
    /// <returns></returns>
    public static QueryConfig<TSearch, TEntity> CreateQueryConfig<TSearch, TEntity>(this TSearch searchModel, TEntity _)
        where TSearch : class
        where TEntity : class
    {
        //使用示例
        ...
        return new QueryConfig<TSearch, TEntity>(searchModel);
    }
